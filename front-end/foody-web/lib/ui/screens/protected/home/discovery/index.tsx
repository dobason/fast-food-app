...
export default function DiscoveryScreen() {
  const { restaurantCuisinesData, groceryCuisinesData, error, loading } = useGetCuisines();
  ...
  return (
    <>
      ...
      <CuisinesSection
        ...
        error={!!error}
      />
      <GroceryList data={groceriesData} loading={restaurantsLoading} error={!!restaurantsError} />
      <TopGroceryPicks />
      <TopRatedVendors />
      <PopularRestaurants />
      <PopularStores />
