        ...
        <div className="p-4 flex flex-col justify-center items-center border-t bg-white dark:bg-gray-800 ">
          ...
          >
            <div className="flex items-center">
              ...
              <span className="text-black text-base font-medium">{t('go_to_checkout_label')}</span>
            </div>
            <span className="text-black text-base font-medium">{formattedSubtotal}</span>
          </button>
          {/* Clear Cart */}
          <button
            ...
            type="button"
          >
            <span className="text-base font-medium">{t('clear_cart_button')}</span>
          </button>
        </div>
      </div>
